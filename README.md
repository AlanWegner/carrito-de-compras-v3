# Este es mi carrito de compras v3

## Sobre el proyecto

Este carrito de compras lo hice con mucho 🤍. En esta ocasión, se utiliza bastante logica, para poder mostar los productos que seleccione el usuario, mostrando el precio total de la compra, mas la sumatoria total de los productos en cantidad.
...
const agregarCarrito = (e) => {
  ...
  const posicion = carritoArray.findIndex(
